...
class SCPStorage:
    ...
    def upload_file(self, mp3_file_bytes, remote_path, make_public=True):

        # Create an SSH client
        try:
            file_obj = BytesIO(mp3_file_bytes)
            ...
            file_url = f'{self.scp_config["audio_url_path"]}/{remote_path.split("/")[-1]}'
